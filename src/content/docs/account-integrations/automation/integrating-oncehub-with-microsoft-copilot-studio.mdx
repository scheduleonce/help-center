...
You can also use the integration along with Microsoft’s other services (Logic Apps, Power Apps, Power Automate) to build custom scheduling applications that use OnceHub’s [**Booking Calendar**](/product/booking-calendars/introduction-to-booking-calendars/introduction-to-booking-calendars) scheduling logic.
