---
title: "How Payment Transaction Details are Sent to Your Guests"
description: "When a paid meeting is scheduled, guests can receive the payment transaction details in two ways:"
products:
  - oncehub
oldUrl: "https://help.oncehub.com/help/how-payment-transaction-details-are-sent-to-your-guests"
sidebar:
  order: 2
---
...
<iframe
  src="https://www.youtube.com/embed/itmVua6tIco?si=wNcwNcuz8O1iQ16j"
  width="100%"
  height="400"
  frameborder="0"
  allowfullscreen
...
4. Add the **Payment amount** and **Payment transaction ID** variables as shown in the image below. ![](files/1762371074489.png)
5. Click **Save** to confirm the changes.

For more detailed guide on guest notifications, please read [**Booking Calendar Guest Notifications**](/human-engagement/booking-calendars/notifications/booking-calendar-guest-notifications).
