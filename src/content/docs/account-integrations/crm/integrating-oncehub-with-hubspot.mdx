...
**TIP:** You can select **Calendar event title** from the HubSpot meeting subject dropdown to sync the [**calendar event title configured in your Booking Calendar**](/human-engagement/booking-calendars/notifications/calendar-events-in-booking-calendars). This allows for more dynamic and descriptive meeting subjects that automatically updates based on the individual event details.

<Aside type="note">

&#x20; Only HubSpot fields compatible with the specific OnceHub Meeting Properties you select will be available in the dropdown for mapping.
