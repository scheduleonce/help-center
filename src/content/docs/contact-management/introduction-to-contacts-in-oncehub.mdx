...
Contacts are at the **core** of how OnceHub manages guest data. The **Contacts page** provides a centralized view of all your guest information. Easily accessible from the left navigation menu, it displays your **contact records** in a tabular view, allowing you to view, [**edit**](/contact-management/managing-contacts-in-oncehub/#how-to-edit-a-contact), filter, [**import**](/contact-management/how-to-import-contacts-into-oncehub/), [**export**](/contact-management/how-to-import-contacts-into-oncehub/#how-to-export-contacts), and bulk [**delete**](/contact-management/managing-contacts-in-oncehub/#how-to-delete-contacts) records all from one central location.
...
- **Contact details:** All information captured through [**mapped Contact Properties**](/account-administration/objects-properties/introduction-to-objects-and-properties/) in Booking Calendars, Routing Forms and Chatbots.
...
If the [**AI Contact Summary**](/account-administration/account-permissions/managing-account-permissions/#ai-contact-summary) is enabled for your account, contact records also provide AI-generated insights to help you quickly understand recent guest interactions and identify recommended next steps.

---

To learn how to navigate to the Contacts page, read **[The Contacts Page](/contact-management/the-contacts-page/)** article.
