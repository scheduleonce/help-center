...
- **Bulk import:** You can import contacts in bulk by importing a CSV file using the [**Import CSV**](/contact-management/how-to-import-contacts-into-oncehub/#how-to-import-contacts) option from the Contacts page.
