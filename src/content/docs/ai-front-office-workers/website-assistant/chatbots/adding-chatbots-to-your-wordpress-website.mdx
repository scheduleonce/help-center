---
title: "Adding Chatbots to Your Wordpress Website"
description: "Adding a chatbot to your Wordpress website is quick and easy. You have three different options:"
products:
  - oncehub
oldUrl: "https://help.oncehub.com/help/adding-chatonce-bots-to-your-wordpress-website"
sidebar:
  order: 9
---
...
2. Edit your website.
3. Add a custom embed wherever you'd like to add a chatbot link.
...
1. Install and activate the custom header plugin of your choice. [**Learn more**](https://wordpress.com/support/adding-code-to-headers/)
2. Paste the custom code from OnceHub to your header and save.
