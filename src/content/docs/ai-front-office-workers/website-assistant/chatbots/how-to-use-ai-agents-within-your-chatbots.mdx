...
No. If you need to capture specific visitor information, it is recommended to use the dedicated [**Question Interactions**](/ai-front-office-workers/website-assistant/chatbots/adding-questions-to-your-chatbot) within your Chatbot instead of the AI Agent Action.

#### How do I offer scheduling through the AI Agent?

You can use the **Routing** tab to direct visitors to a [**Booking Calendar Interaction**](/ai-front-office-workers/website-assistant/chatbots/offering-scheduling-in-your-chatbot) once the AI Agent identifies that a visitor wants to book a call.
...
To alert your team members, add a [**User Notification Interaction**](/ai-front-office-workers/website-assistant/chatbots/setting-up-user-notifications-for-your-chatbot) to your Chatbot flow immediately before the **AI Agent** Interaction.
