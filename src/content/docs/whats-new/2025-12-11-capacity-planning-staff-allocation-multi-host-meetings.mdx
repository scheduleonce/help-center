---
title: "Capacity Planning, Create Ad Hoc Multi-Host Meetings, New Developer Center and More..."
date: "2025-12-11"
description: "The new Capacity Planning Report provides predictive insights to help you manage resources more effectively."
products:
  - oncehub
oldUrl: "https://help.oncehub.com/help/dec-11-2025-capacity-planning-for-optimizing-staff-allocation-create-ad-hoc-multi-host-meetings-all-new-developer-center-and-more"
sidebar:
  order: 10
---
...
![](files/capacity-planning-a491ee.png)
...
To explore this new report take a look at our [**Capacity Planning for Optimizing Staffing Levels** ](/activities-analytics/reporting-analytics/capacity-planning-for-optimizing-staffing-level)article.
...
See our article on [**How to Add Co-Hosts to Meetings Using the Booking Link**](/human-engagement/booking-calendars/sharing-embedding/how-to-quickly-create-ad-hoc-multi-host-meetings) to learn more.
...
- **Cleaner API Navigation:** We have reorganized our API documentation for better navigation. Use the **API Reference dropdown** in our [**Developer Center**](/developers/overview/introduction/) to easily switch between the documentation for [**Booking Calendar APIs**](/developers/api/#tag/authentication) and [**Booking Pages APIs**](/scheduleonce/developers/api/#tag/authentication), ensuring instant access to the correct resource.

This is just the beginning, we are continuously enhancing our [**Developer Center**](/developers/overview/introduction/)with more features, improved tools and richer documentation. Watch this space for what’s coming next.
...
- You can now update existing contact details using the OnceHub API, including fields like name and custom fields. Previously, contact details could only be updated when triggered by system actions (such as scheduling a meeting) or edited manually in the OnceHub interface. With this new capability, you can **programmatically update** most contact fields, **except email address and mobile phone** (support for updating these fields is coming soon), making it easier to keep customer data consistent across your systems.
