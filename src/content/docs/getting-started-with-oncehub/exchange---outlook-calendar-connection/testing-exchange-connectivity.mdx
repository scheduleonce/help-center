...
*   Determining your [EWS URL](/getting-started-with-oncehub/exchange---outlook-calendar-connection/how-to-determine-the-ews-url/ "How to determine the EWS URL") (if EWS is enabled).
