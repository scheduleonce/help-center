---
title: "Introduction to Billing [Classic]"
---

import { Aside } from '@astrojs/starlight/components';

# [](https://help.oncehub.com/help/pdfexport/id/5c11fb8a6e121cb21d029764 "Download PDF")[](https://help.oncehub.com/help/introduction-to-billing# "Print article")[](https://help.oncehub.com/help/introduction-to-billing# "Email article")
...
In the top navigation menu, select the gear icon → **Billing**. You must be an [administrator](/user-type-member-vs-admin/ "Differences between Administrator and Member") to initiate any OnceHub transactions.
...
#### Purchasing your first OnceHub product[](https://help.oncehub.com/help/pdfexport/id/5c124b7f6e121c9448029749 "Download PDF")[](https://help.oncehub.com/help/purchasing-and-upgrading-your-scheduleonce-account# "Print article")[](https://help.oncehub.com/help/purchasing-and-upgrading-your-scheduleonce-account# "Email article")

OnceHub seats can be purchased with a monthly or annual subscription. 

To purchase a OnceHub seat, you must be a [OnceHub Administrator](/user-type-member-vs-admin/ "Differences between Administrator and Member").
...
Once you've completed your first purchase, you won't be able to change your billing cycle. If you've already purchased a subscription and would like to change your billing cycle, please [contact us](http://help.oncehub.com/help/contact-us).

## Monthly subscription

*   On each monthly billing date, you'll be billed in advance for the upcoming month. 
*   You can add or remove seats at any time.[](https://help.oncehub.com/help/downgrading-your-scheduleonce-account "Removing User licenses")
...
*   When you add seats, you'll immediately be charged a prorated adjustment for them.[](https://help.oncehub.com/help/adding-user-licenses-annual "Adding User licenses to an annual subscription")
...
5\. Click **Proceed to** [**payment**](/payment/).

6\. On the **Secure payment** page, select your **Payment method**. You can pay using a credit card or a PayPal account. 

*   [**Credit card**](/payment/)**:** Enter your payment details and click **Submit payment** to complete the purchase. 
*   [**PayPal**](/payment/)**:** Click the **Pay with PayPal** button. You'll be prompted to log in to your PayPal account and choose a way to pay. Click **Agree & Continue** to create a Billing Agreement and complete the purchase.
...
[Does my User need an assigned seat?](/your-account-user-management#faq/ "User management and licensing")
...
#### How to change your billing cycle[](https://help.oncehub.com/help/pdfexport/id/5eb27a00ad121ce3061edea6 "Download PDF")[](https://help.oncehub.com/help/how-to-change-your-billing-cycle# "Print article")[](https://help.oncehub.com/help/how-to-change-your-billing-cycle# "Email article")
...
3.  You will see a popup. Follow the directions to apply the changes to your account.  
    ![](../../../../../assets/docs/user-account-management/account-management/billing/images/1687527748046.png)_Figure 1: Change billing cycle popup - This example changes the cycle from monthly to annual_
...
#### Purchasing and managing SMS credits[](https://help.oncehub.com/help/pdfexport/id/5c124ddaad121ca675aa99bf "Download PDF")[](https://help.oncehub.com/help/sms-pricing# "Print article")[](https://help.oncehub.com/help/sms-pricing# "Email article")
...
<table><tbody><tr><td><strong>SMS credits</strong></td><td><p dir="ltr"><strong>Cost</strong></p></td><td><strong>Cost per SMS credit</strong></td></tr><tr><td>100</td><td>USD 15.00</td><td>USD 0.15</td></tr><tr><td>200</td><td>USD 25.00</td><td>USD 0.125 </td></tr><tr><td>500</td><td>USD 50.00</td><td>USD 0.10 </td></tr><tr><td>1000</td><td>USD 90.00</td><td>USD 0.09</td></tr><tr><td>2000 or more</td><td>TBD</td><td>USD 0.08</td></tr></tbody></table>
...
2.  Click the **Add credits** button (Figure 1).![](../../../../../assets/docs/user-account-management/account-management/billing/images/1687527760353.png)_Figure 1: Add SMS credits_
3.  In the **Secure checkout** page, select the quantity of SMS credits you would like to purchase.
4.  Click **Proceed to payment**.
5.  Select a payment method. You can choose from payment methods that are already on file [](https://help.oncehub.com/help/managing-payment-methods "Managing payment methods")or click **use a new payment method** to add and pay with a new payment method. By default, the payment is charged to your primary payment method.
...
![](../../../../../assets/docs/user-account-management/account-management/billing/images/1687527760252.png)_Figure 2: SMS credits remaining_
...
# Tracking SMS usage[](https://help.oncehub.com/help/pdfexport/id/5c124debad121c1579aa99d2 "Download PDF")[](https://help.oncehub.com/help/sms-log-data# "Print article")[](https://help.oncehub.com/help/sms-log-data# "Email article")
...
1.  Select the gear icon in the top navigation menu → **Billing**→ **Seats** .
2.  Then, click **View SMS log** (Figure 1).  
    ![](../../../../../assets/docs/user-account-management/account-management/billing/images/1687527778928.png)Figure 1: View SMS log
...
**Booking page:** The [Booking page](/introduction-to-booking-pages/ "Introduction to Booking pages") associated with the SMS. Test SMS notifications do not have Booking pages associated with them.
...
**Status:** One of the following [delivery statuses](/user-account-management/account-management/account-management/understanding-sms-delivery-statuses/ "Understanding SMS delivery statuses") will be displayed.
