---
title: "Collecting Consent for Processing Under the GDPR [Classic]"
---
...
In order to obtain clear consent for OnceHub to process the data, it is recommended that you [add a field](/introduction-to-the-booking-forms-editor/ "Introduction to the Booking forms editor") in your OnceHub [Booking form](/introduction-to-the-booking-form-redirect-section/ "Introduction to the Booking form and redirect section") to request consent (See Figure 1).

![](../../../../../assets/docs/user-account-management/security-privacy-compliance/privacy/images/1547627900014.png)Figure 1: Consent requested in the Booking form

# How to add a consent field to your Booking form

1\. Go to the [Booking forms editor](/introduction-to-the-booking-forms-editor/ "Introduction to the Booking forms editor") and click **Add Custom field to library** (See Figure 2).

![](../../../../../assets/docs/user-account-management/security-privacy-compliance/privacy/images/gdpr-7.png)Figure 2: The Booking forms editor
...
_![](../../../../../assets/docs/user-account-management/security-privacy-compliance/privacy/images/1547627855503.png)_Figure 3: Add Custom field to library
...
![](../../../../../assets/docs/user-account-management/security-privacy-compliance/privacy/images/1547627855283.png)Figure 4: Link to your company’s privacy policy
...
![](../../../../../assets/docs/user-account-management/security-privacy-compliance/privacy/images/gdpr-8.png)Figure 5: Add the field to the booking form
...
6\. Next, you can determine the position of the field and whether or not it will be mandatory for Customers to check. It is recommended that this field be mandatory (See Figure 6).
 ...
 ![](../../../../../assets/docs/user-account-management/security-privacy-compliance/privacy/images/gdpr-9.png)Figure 6: Determine the position and whether the field is mandatory  

You are all set! Your Booking form now requests consent for processing data. Be sure to attach this Booking form to the relevant Booking pages or Event types. [Learn more about adding the Booking form to your Booking page and Event types](/booking-form/ "Introduction to Booking forms")