...
**Note**To comply with HIPAA, you must sign a Business Associate Agreement (BAA) with OnceHub. The standard OnceHub BAA is available for paid accounts that qualify. 
