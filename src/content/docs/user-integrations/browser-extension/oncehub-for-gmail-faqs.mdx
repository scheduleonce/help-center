...
**A:** If you can't use a booking link in OnceHub for Gmail, there may be a calendar connection error in your account. Sign in to your OnceHub Account. Then, select your profile picture or initials in the top right-hand corner → **User Integrations** → select your **Calendar integration** and click the **Reconnect your calendar** button.
