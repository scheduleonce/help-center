...
3. In the **To** field, enter the email address of the person you want to share your Booking page link with.
   ...
   If you do not enter an email address, you will need to enter the **Customer name** and **Customer email** in the OnceHub for Gmail extension window when you generate a Personalized link.
