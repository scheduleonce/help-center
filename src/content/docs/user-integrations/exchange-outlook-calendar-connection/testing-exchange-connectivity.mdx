...
- Determining your [EWS URL](/user-integrations/exchange-outlook-calendar-connection/how-to-determine-ews-url "How to determine the EWS URL") (if EWS is enabled).
