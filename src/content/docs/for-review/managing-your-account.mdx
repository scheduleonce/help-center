...
description: "Your account is where you can find the settings to control all of your key dealings with OnceHub, like adding users and user licenses, updating your security..."
products:
  - oncehub
---
...
<video controls width="100%">
  <source src="videos/office-video-background.mp4" type="video/mp4" />
...
Only Administrators have access to the following sections in the OnceHub **Account settings** section. You do not need an assigned product license to access this section. Learn [more](/account-administration/user-management/user-management-and-seats "User management and licensing")

### [Users](/account-administration/user-management/user-management-and-seats "User management and seats")
...
### [Teams](/for-review/managing-your-account#creating-and-managing-teams)

In the **Teams** section, you can create teams of OnceHub users. These teams can be assigned to field live calls, or be assigned to host scheduled meetings. You can [assign managers](/account-administration/user-management/user-roles-overview "Differences between administrator, member, and team manager") to these teams who can handle some of their administrative load.

### [Alert center](/for-review/managing-your-account#alert-center)

The **alert center** allows you to create alerts which keep you updated on every step of the booking process. Read on for [more information](/for-review/managing-your-account#alert-center) on how to set up an alert.

### [Contact fields](/ai-front-office-workers/website-assistant/chatbots/contacts-in-chatbots "Contacts")
...
- Click [here](/scheduleonce/account-integrations/crm/salesforce/salesforce-integration "Salesforce integration") to find more about integrating with Salesforce
- Click [here](/scheduleonce/account-integrations/crm/infusionsoft/infusionsoft-integration "Infusionsoft integration") to find more about integrating with Infusionsoft

### [API & Webhooks](/scheduleonce/account-integrations/automation/zapier/connect-zapier-to-oncehub "Connect Zapier to OnceHub")

In the **API & Webhooks** section, you can generate and copy an API key to use with our API.

### [Billing](/scheduleonce/insights-operations/billing-subscription-management/introduction-to-billing "Introduction to billing")
...
### [Security](/security-compliance/security/introduction-to-security "Introduction to Security") and [compliance](/security-compliance/compliance/compliance-at-oncehub "Compliance at OnceHub")

In the **Security and Compliance** sections, you can manage:

- [Password policies](/security-compliance/security/password-policies "Password Policies") - including settings for Password length, Password complexity, Password expiration, and Password history.
- [Account lockout policies](/security-compliance/security/account-lockout-policies "Account lockout policies") - you can enable or disable account lockout and set the number of unsuccessful login attempts allowed before account lockout occurs.
- [Session policies](/security-compliance/security/session-policies "Session policies") - you can enable or disable session timeout and manage the session timeout period.
- Provide OnceHub with the contact information of your Data Protection Officer and your European Union representative.
- Describe your processing of personal data in OnceHub as required by the GDPR. [Learn more about maintaining records of processing in your OnceHub account](/security-compliance/privacy/maintaining-records-of-processing-under-gdpr "Maintaining records of processing under the GDPR")
...
Admins can update all chatbots and forms. Members can only update those an admin assigned to them
...
For more specific details on what team managers can and can't do, see [here](/account-administration/user-management/user-roles-overview "Differences between administrator, member, and team manager").
...
![](files/1724153196040.png)Figure 1: Creating a team and adding team members.
...
Only administrators are able to create alerts, but a member user can be added as a recipient of any global alert.

[Learn more](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member") about the differences between administrators and member users.
...
![](files/1716888020421.png)The Alerts center
...
![](files/1722501561254.png)Creating a custom alert

<Aside type="note">

If the user who has been scheduled with has turned off their email notifications for bookings received, canceled, or rescheduled, then users on the global alert will not receive any notifications either.
...
![](files/1690555023310.png)_Figure 1: Notification center_
...
![](files/1690555022815.png) _Figure 2: Issue example_

Issue notifications include:

- [Google Calendar](/user-integrations/google-calendar-connection/connect-oncehub-to-your-google-workspace "Connect your Google Calendar") connection error
- [Microsoft 365 Calendar](/user-integrations/ms-office365-calendar-connection/connect-oncehub-to-your-microsoft-office-365 "Connect your Microsoft 365 (Office 365) Calendar") connection error
- [Exchange/Outlook Calendar](/user-integrations/exchange-outlook-calendar-connection/connect-oncehub-to-your-exchangeoutlook-calendar "Connect your Exchange/Outlook Calendar") connection error
- [iCloud Calendar](/user-integrations/icloud-calendar-connection/connect-oncehub-to-your-icloud-calendar "Connect your iCloud Calendar") connection error
- [Salesforce API](/scheduleonce/account-integrations/crm/salesforce/connecting-salesforce-api-user "How to connect a Salesforce API User") connection error
- [Salesforce field validation](/scheduleonce/account-integrations/crm/salesforce/handling-required-salesforce-fields-in-field-validation-step "Handling required Salesforce fields in the Field validation step") error
- [Infusionsoft](/scheduleonce/account-integrations/crm/infusionsoft/connecting-to-infusionsoft "Connecting to Infusionsoft") connection error
- [Zoom](/connect-your-video-conferencing-app "Connect your video conferencing app") connection error
- [GoToMeeting](/connect-your-video-conferencing-app "Connect your video conferencing app") connection error
- Depleted [SMS credit](/scheduleonce/insights-operations/billing-subscription-management/introduction-to-billing "SMS Pricing") balance
...
![](files/1690555023037.png) _Figure 3: Warning example_

Warning notifications include:

- [GoToMeeting](/connect-your-video-conferencing-app "Connect your video conferencing app")’s access token is about to expire
- Low [SMS credit](/scheduleonce/insights-operations/billing-subscription-management/introduction-to-billing "SMS Pricing") balance
...
Invited Users need to sign in for the first time by clicking the **Sign in to your account** button in the email invitation from the OnceHub Administrator of the account. [Learn more about joining your organization's OnceHub Account](/getting-started/introduction-oncehub/joining-your-organizations-oncehub-account "Joining your organization's OnceHub account")
...
<Aside type="note">
  If you have enabled two-factor authentication for your profile, your sign in
  process will include an additional step. Learn more about signing in with
  two-factor authentication in this article.
</Aside>
...
[Learn more about configuring SSO for your account](/security-compliance/security/configuring-single-sign-on-sso-for-your-account)
...
Two-factor authentication has a built-in lockout policy to detect irregular activity. If any irregular sign-in activity is detected, your account will be locked. If your account is locked, contact your [account Administrator](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member") to unlock it.
...
If you only want your Booking page or Master page to become unavailable, you can simply disable it and there is no need to delete your account. [Learn how to disable your Booking page](/scheduleonce/event-types-booking-pages/booking-pages/disabling-your-booking-page "Disabling your Booking page")

</Aside>

##### Requirements

To access the **Account settings** page and delete your account, you must be a [OnceHub Administrator](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member").
...
4. In the **Delete account** pop-up (Figure 1), check the box marked **I want to delete my account. I understand this cannot be undone**. Figure 1: Delete account pop-up - feedback box
...
Once installed, any user on the domain can create the first OnceHub account. That account will become the first administration account and all users will be added from that account only. [Learn about adding Users](/account-administration/user-management/user-management-and-seats "User management and licensing")
