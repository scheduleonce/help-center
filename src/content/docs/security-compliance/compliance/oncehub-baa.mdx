...
description: "The OnceHub Business Associate Agreement (BAA) is a legal mechanism for ensuring patient data is adequately protected."
products:
  - oncehub
oldUrl: "https://help.oncehub.com/help/the-oncehub-baa"
sidebar:
  order: 4
---
...
To comply with the terms of the OnceHub BAA, account holders must use our service in a HIPAA compliant manner. For example, you should enable account security policies to satisfy the requirements of the [HIPAA security rule](/security-compliance/compliance/hipaa-compliance "HIPPA Compliance"). Users that are not familiar with the HIPAA security rule should follow best practices when securing their OnceHub account. [Learn more about securing your account](/security-compliance/security/security-best-practices "Security best practices")
