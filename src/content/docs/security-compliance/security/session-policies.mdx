...
description: "OnceHub recommends the implementation of Short sessions. Short sessions are a security feature that protect your OnceHub account from unauthorized access."
products:
  - oncehub
oldUrl: "https://help.oncehub.com/help/session-policies"
sidebar:
  order: 8
---
...
<iframe
  src="https://www.youtube.com/embed/zbWma_ZkuVs?feature=youtu.be&wmode=opaque&rel=0"
  width="100%"
  height="400"
  frameborder="0"
  allowfullscreen
