...
products:
  - scheduleonce
oldUrl: "https://help.oncehub.com/help/password-policies-old"
sidebar:
  order: 1
---
...
You must be a OnceHub Administrator to make changes to password policies. However, you do not need an assigned product license.
