...
This article describes potential issues with [Exchange/Outlook Calendar](/user-integrations/exchange-outlook-calendar-connection/connect-oncehub-to-your-exchangeoutlook-calendar "Connecting to your personal Exchange Calendar") [](/user-integrations/ms-office365-calendar-connection/connect-oncehub-to-your-microsoft-office-365 "Connecting to Office 365 Calendar with OAuth 2.0")integration and how these issues can be fixed. If you’re still having problems, please [contact us](/contact-us/) and we will be happy to assist you.

## Unable to connect to the Exchange server

The [Exchange/Outlook Calendar connection wizard](/user-integrations/exchange-outlook-calendar-connection/connect-oncehub-to-your-exchangeoutlook-calendar "Connecting to your personal Exchange Calendar") will take you through the shortest and easiest way to connection. You will first be asked for your Outlook email and password, and then additional fields may be required.
