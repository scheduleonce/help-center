...
This article is relevant to Users who have difficulty [connecting to their domain mailbox](/account-integrations/corporate-mailbox/ "Corporate Mailbox integration") and in cases where the feature has suddenly stopped working.
...
- If you've changed your email password, you'll need to disconnect and reconnect your [Corporate Email](/account-integrations/corporate-mailbox/ "Corporate Mailbox integration").
- If you've recently set up G Suite 2-step verification, you should generate an App password via Google and enter this in the password field under the [Corporate Email](/account-integrations/corporate-mailbox/ "Corporate Mailbox integration") settings. [Learn more about G Suite passwords](https://support.google.com/accounts/answer/185833?hl=en)
