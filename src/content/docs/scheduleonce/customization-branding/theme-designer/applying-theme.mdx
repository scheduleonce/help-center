...
3. In the **Overview** section, select a theme from the **Theme** drop-down menu (Figure 1). [Learn more about the Booking page Overview](/scheduleonce/event-types-booking-pages/booking-pages/booking-pages-overview "Booking page: Overview section") and [Master page Overview](/scheduleonce/master-pages-resource-pools/master-pages/master-pages-overview "Master Page: Overview section").

<video
  src="/videos/apply-theme-in-so-setup.mp4"
  autoplay
  loop
  muted
  playsinline
...
<video
  src="/videos/apply-theme-in-designer.mp4"
  autoplay
  loop
  muted
  playsinline
