...
5. Alternatively, you can duplicate an existing theme by clicking the **Duplicate theme** button (Figure 2). ![](files/duplicate-theme.gif)Figure 2: Duplicate theme button
