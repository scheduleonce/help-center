...
All OnceHub Administrators can access the Booking forms editor. On the **Booking page** on the left, select the **Booking forms editor** on the left.
...
All data collected via the Booking form is available in your [reports](/scheduleonce/reporting/ "Reports"). You can select the fields you want to display in any Detail report in the **Reports** section of the left.
