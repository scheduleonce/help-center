...
- [Sending invitations to new Users](/account-administration/user-management/user-management-and-seats "Adding Users")
...
All [OnceHub Administrators](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member") can access the Notification templates editor. Go to **Booking pages** in the bar on the left. Select the **Notification templates editor** on the left.
