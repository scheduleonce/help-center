...
1. Place the cursor in the template editor text box where you want to insert the Dynamic field (Figure 5). <video src="/videos/notifications1opt.mp4" autoplay loop muted playsinline></video>

   Figure 5: Place the cursor in the template editor text box

2. In the **Dynamic Fields** column on the right, click the Dynamic field you want to add (Figure 6). <video src="/videos/notifications2opt.mp4" autoplay loop muted playsinline></video>
