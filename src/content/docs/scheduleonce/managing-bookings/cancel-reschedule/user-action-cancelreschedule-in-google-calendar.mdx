...
<YouTubeEmbed id="N-dyqUCI-Qk" title="User action: Cancel/reschedule in Google Calendar" />
When you're [connected to a Google
Calendar](/user-integrations/google-calendar-connection/connect-oncehub-to-your-google-workspace
