...
- **Webhooks**: Consider using [webhooks](/scheduleonce/developers/webhooks/introduction-to-webhooks) instead of polling for real-time updates.

## See Also

- [Bookings API Reference](/scheduleonce/developers/api/booking-calendars/#tag/bookings)
- [Pagination](/scheduleonce/developers/overview/pagination)
- [Rate Limits](/scheduleonce/developers/overview/rate-limits)
- [Webhooks](/scheduleonce/developers/webhooks/introduction-to-webhooks)
