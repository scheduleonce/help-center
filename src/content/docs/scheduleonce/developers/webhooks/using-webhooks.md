...
1. [Create a webhook subscription](/scheduleonce/developers/api/booking-calendars/#tag/webhooks/POST/webhooks) by sending a POST request to the **/webhooks** endpoint, configured with the relevant event triggers and the URL where you want to receive data.
