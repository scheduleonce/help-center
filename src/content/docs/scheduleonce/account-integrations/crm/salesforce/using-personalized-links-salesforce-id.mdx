...
For security and privacy reasons, using CRM record IDs to skip or prepopulate the Booking form is not compatible with [collecting data from an embedded Booking page](/scheduleonce/developers/client-side-api/embedded-booking-calendar-events "Embedded booking events") or [redirecting booking confirmation data](/scheduleonce/event-types-booking-pages/booking-forms-redirect/automatic-redirect "Automatic redirect").
