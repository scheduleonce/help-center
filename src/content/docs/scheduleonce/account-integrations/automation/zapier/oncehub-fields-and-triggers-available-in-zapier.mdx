...
| Booking - Physical location                                 | The address where the meeting will take place, as specified in the [**Conferencing / Location**](/scheduleonce/event-types-booking-pages/booking-pages/booking-pages-location-settings "Booking page: Conferencing / Location section")[ ](http://help.scheduleonce.com/customer/portal/articles/1239662?b_id=9178)section of the Booking page                                 |
...
- [Canceled by User in the connected Outlook Calendar](/non-visible-articles/pc-connector-for-outlook/upgrading-the-outlook-connector-with-a-clean-reinstall "User action: Cancel or Reschedule in Outlook Calendar")
