...
Different third-party forms and custom forms provide this logic in different ways. Typically, the form can filter customers based on a duplicate Customer email address, custom field, or an IP address. We'll look at a typical solution using [Wufoo forms](https://www.wufoo.com/).
