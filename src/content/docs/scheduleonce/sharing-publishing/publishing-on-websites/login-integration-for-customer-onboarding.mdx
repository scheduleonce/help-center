...
5. [Add dynamic user attributes to your code](/scheduleonce/sharing-publishing/publishing-on-websites/login-integration-for-customer-onboarding#adding-dynamic-user-attributes-to-the-code). This ensures that your booking process is prepopulated with your logged-in Customer information.
