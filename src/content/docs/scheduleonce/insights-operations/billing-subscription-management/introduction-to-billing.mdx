...
In the top navigation menu, select the gear icon → **Billing**. You must be an [administrator](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member") to initiate any OnceHub transactions.
...
To purchase a OnceHub seat, you must be a [OnceHub Administrator](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member").
...
- You can add or remove seats at any time.[](/account-administration/user-management/user-management-and-seats "Removing User licenses")
...
- When you add seats, you'll immediately be charged a prorated adjustment for them.[](/account-administration/user-management/user-management-and-seats "Adding User licenses to an annual subscription")
...
[Does my User need an assigned seat?](/account-administration/user-management/user-management-and-seats#frequently-asked-questions "User management and licensing")
...
**Status:** One of the following [delivery statuses](/billing/sms-delivery-statuses-troubleshooting-and-regional-guidelines "Understanding SMS delivery statuses") will be displayed.
