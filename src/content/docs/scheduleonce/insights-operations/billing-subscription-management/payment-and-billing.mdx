...
description: "The Billing section stores your primary payment method and secondary payment methods."
products:
  - scheduleonce
oldUrl: "https://help.oncehub.com/help/payment"
sidebar:
  order: 2
---
...
To manage payment methods, you must be a [OnceHub Administrator](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member").
...
2. Select the gear icon in the top navigation menu → **Billing** → **Payment methods**.![](files/1687527868558.png)_Figure 1: Payment methods section_
...
1\. In the **Payment method** section, select **Credit card** (Figure 2). ![](files/1687527868621.png) _Figure 2: Selecting credit card as the payment method_
...
1\. In the **Payment method** section, select **PayPal** (Figure 3). ![](files/1687527868348.png) _Figure 3: Selecting PayPal as the payment method_
...
5. Click **Continue**.
6. Click **Agree & Continue** to authorize the creation of a Billing agreement between OnceHub and your PayPal account. If authorization is successful, the Billing agreement with PayPal is created and added as a payment method.
...
3. Select **Make primary** from the drop-down menu. ![](files/1687527868482.png)_Figure 4: Payment methods action menu_
...
![](files/1687527868795.png)_Figure 5: Selecting a payment method when making a one-off purchase_
...
Any User in your OnceHub Account can receive billing notifications. They do not need an assigned product seats. [Learn more](/account-administration/user-management/user-management-and-seats "User management and licensing")

[OnceHub Administrators](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member") can select which Users in the account should receive billing notifications and decide which billing notifications each User will receive. By default, the OnceHub Administrator who made the first purchase on the account will receive all billing notifications.
...
You must be a [OnceHub Administrator](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member") to manage billing notifications.
...
You do not need an assigned product seat to access billing, though you do need to be an Administrator. [Learn more](/account-administration/user-management/user-management-and-seats "User management and licensing")
...
By default, all [OnceHub Administrators](/account-administration/user-management/user-roles-overview "Differences between Administrator and Member") receive the OnceHub Payment integration transactions fee invoice. You can add additional billing contacts who will be copied on to this invoice. For example, you may wish to add your company’s accountant or bookkeeper as an additional billing contact.
...
Is your organization tax-exempt? [Submit your certificate](/scheduleonce/insights-operations/billing-subscription-management/introduction-to-billing)
...
**A:** A Billing Agreement is created between OnceHub and PayPal in the following scenarios:
