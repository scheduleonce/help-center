...
To edit Booking page access permissions, you must be a OnceHub Administrator. However, you do not need a license.
...
You must be assigned a scheduled meetings license to be Owner of an enabled Booking page.
...
You do not need an assigned scheduled meetings license to be Editor of a Booking page.
...
You do not need an assigned scheduled meetings license to be Viewer of a Booking page.
