...
- **Why is busy time not blocking my availability on my booking pages?** **A:** There may be a number of reasons, depending on your Booking page settings and the calendar that you've connected to. Learn more about [troubleshooting Booking page issues with busy time](/scheduleonce/user-integrations/basics-user-integrations/troubleshooting/busy-times-not-blocking-availability "Booking page troubleshooting: Why does my Booking page say I’m available when I’m busy?").
- **Why are all-day events not blocking my availability on my booking pages?**
  **A:** By default, all day events are set to "Available" or "Free" in your calendar. You should open the event in the calendar and change its status to “Busy." If this does not help, you can try some other solutions from our article on[ troubleshooting Booking page issues with busy time](/scheduleonce/user-integrations/basics-user-integrations/troubleshooting/busy-times-not-blocking-availability "Troubleshooting: Why does my Booking page say I’m available when I’m busy?").
- **Why am I receiving a settings conflict when attempting to select a calendar for busy time retrieval?**
  **A:** This is because you're also using the Group sessions setting in the [Scheduling options section](/scheduleonce/event-types-booking-pages/scheduling-options/introduction-to-scheduling-options "Introduction to the Scheduling options section").
