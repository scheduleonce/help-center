...
The ownership of Booking pages can be changed by any OnceHub Administrator with a scheduled meetings license. You do not need to have a license to assign Booking page ownership.
...
The User must have a scheduled meetings license assigned to them in order to be Owner of an enabled Booking page.
