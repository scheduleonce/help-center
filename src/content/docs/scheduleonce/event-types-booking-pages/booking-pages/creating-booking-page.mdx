...
To create Booking pages, you must be either a OnceHub Administrator or a Member with the permission enabled in your Profile.

You do not need an assigned product license to create a Booking page.
