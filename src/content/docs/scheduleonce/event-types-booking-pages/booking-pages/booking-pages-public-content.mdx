...
By default, the customer-facing interface also includes OnceHub branding in the left pane of your Booking page; for instance, "Powered by OnceHub." You can adjust this according to your preference in your OnceHub account **Settings** page. [Learn more](/account-administration/account-permissions/managing-account-permissions/#powered-by-oncehub-banner "Learn more")
