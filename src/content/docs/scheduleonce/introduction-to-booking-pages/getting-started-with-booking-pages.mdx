...
![](files/availability-scheduled-meetings.gif)Figure 1: Update your availability

[Learn more about your availability](/profile-management/managing-your-profile-in-oncehub)
...
![](files/booking-pages-associated-calendars.gif)Figure 3: Associated calendars retrieving busy time

### Connect your video conferencing

Booking Pages seamlessly integrates your booking activities with [Zoom](/user-integrations/basics-user-integrations/connect-your-video-conferencing-app), [Google Meet](/user-integrations/basics-user-integrations/connect-your-video-conferencing-app), [Microsoft Teams](/user-integrations/basics-user-integrations/connect-your-video-conferencing-app), [GoToMeeting](/user-integrations/basics-user-integrations/connect-your-video-conferencing-app), or [Webex Meetings](/user-integrations/basics-user-integrations/connect-your-video-conferencing-app) through all phases of the booking lifecycle. When a booking is made, video conferencing session details are integrated with all Booking Pages notifications and a video conferencing session will be created automatically.
...
**![](files/video-location-bp.gif)Figure 5: Add video conferencing to your Booking page location**
...
![](files/update-ets.gif)Figure 7: Update your Event type settings
...
![](files/update-public-content.gif)Figure 8: Add customer-facing details
