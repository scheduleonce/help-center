...
1.  In your Chrome browser, click the three dots (action menu) in the top right corner (Figure 1).  
    ![](../../../../assets/docs/integrations/browser-extension/images/1571210942272.png)Figure 1: Chrome browser three dots (action menu)
2.  In the drop-down menu, select **More tools -> Extensions**.
3.  In the **OnceHub for Gmail** box, click **Remove** (Figure 2).  
      
    ![](../../../../assets/docs/integrations/browser-extension/images/remove-1-v2.png)_Figure 2: OnceHub for Gmail options in extensions menu._
4.  Once you click **Remove**, you will see a confirmation screen (Figure 3). Click **Remove.**  
      
    ![](../../../../assets/docs/integrations/browser-extension/images/remove-2-v2.png)_Figure 3: Removal confirmation._
...
2.  Click **Remove from Chrome** (Figure 4).  
    ...
    ![](../../../../assets/docs/integrations/browser-extension/images/remove-3-v3.png)
