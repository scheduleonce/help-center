---
title: "Booking Calendar Meeting Types"
description: "Booking Calendars offer flexible meeting types to accommodate a range of scheduling needs, including single-host, multi-host, and multi-guest setups."
products:
  - oncehub
oldUrl: "https://help.oncehub.com/help/booking-calendar-meeting-types"
sidebar:
  order: 2
---
...
Dynamic selection single-host meetings use [**Teams**](/human-engagement/booking-calendars/booking-settings/booking-calendar-meeting-distribution-options) to assign meetings to available team members based on predefined distribution methods, such as round-robin or load balancing.
...
**Multi-Guest Meetings** allow clients to invite additional participants, such as colleagues, partners, or family members, during the booking process. This feature can be enabled using the [**Additional Guests**](/human-engagement/booking-calendars/booking-forms/booking-calendar-booking-forms#adding-additional-guests) option in the **Booking Form** settings.
