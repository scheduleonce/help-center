...
| Default Time Zone           | `iana_time_zone=`   | [**Sets the default time zone used to display availability to the guest.**](https://help.oncehub.com/help/how-to-override-the-guest-time-zone-on-your-booking-link) | `iana_time_zone=America/New_York` |
