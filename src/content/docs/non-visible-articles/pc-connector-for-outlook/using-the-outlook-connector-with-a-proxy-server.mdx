...
1.  In your Internet Explorer browser, go to **Tools** in the top right corner of the screen -> **Internet options** -> **Connections** tab -> click the **LAN settings** button and enter the details of your proxy server:
    ...
    ![](../../../../assets/docs/non-visible-articles/pc-connector-for-outlook/images/1547833487514.png)
    
    You must do this in Internet Explorer because Internet Explorer updates the Windows operating system with this data, which also makes it available to the connector.
