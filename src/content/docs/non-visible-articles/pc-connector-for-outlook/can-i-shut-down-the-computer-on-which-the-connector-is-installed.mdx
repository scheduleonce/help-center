...
If you are seeing double bookings in your Outlook Calendar, please check suggestions in our troubleshooting article for [when the connector is not syncing as expected](/non-visible-articles/pc-connector-for-outlook/outlook-connector-is-not-syncing/ "Outlook Troubleshooting: The connector is not syncing as expected").
