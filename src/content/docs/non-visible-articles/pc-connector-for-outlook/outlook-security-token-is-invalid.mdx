...
![](../../../../assets/docs/non-visible-articles/pc-connector-for-outlook/images/security-token.png)Figure 1: Connector credentials
...
![](../../../../assets/docs/non-visible-articles/pc-connector-for-outlook/images/1551440958736.png)
...
![](../../../../assets/docs/non-visible-articles/pc-connector-for-outlook/images/1549532745180.png)

Once this is done, open the connector again and see if the security token now works. 

**Note** Windows XP is no longer supported by Microsoft. As a result, it does not support updated TLS protocols. Because of this, the Outlook connector will not work on machines running Windows XP.  
.