...
5. When your computer is back up, sign in to your OnceHub account and [re-install the Outlook connector](/installing-the-pc-connector-for-outlook "Installing the PC Connector for Outlook")

6. If you still experience issues, you should [generate a connector log](/generating-an-outlook-connector-log-file "Generating an Outlook connector log file") and [send it to us](/contact-us).
