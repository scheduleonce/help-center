...
![](../../../../assets/docs/non-visible-articles/pc-connector-for-outlook/images/1547833730434.png)Figure 1: Calendars
...
The easiest way to check if the connector is conflicting with another add-in is by disabling the OnceHub connector for Outlook add-in. Please be advised that disabling the add-in will also disable real-time sync. To use the connector without an active add-in, please [change your syncing mode](/non-visible-articles/pc-connector-for-outlook/outlook-connector-sync-modes/ "Outlook connector sync modes") to auto-sync.

To disable the connector add-in, follow these steps:

*   Open the connector and click on **Settings** (see Figure 2).  
    ![](../../../../assets/docs/non-visible-articles/pc-connector-for-outlook/images/connector-for-outlook-settings.png)Figure 2: Connector settings
*   Go through the setup wizard, select Every 5 minutes on the final step, and click Finish (see Figure 3).  
      
    ![](../../../../assets/docs/non-visible-articles/pc-connector-for-outlook/images/1547833730554.png)Figure 3: Sync mode settings
...
If you are still experiencing performance drops in Outlook, please [generate logs](/non-visible-articles/pc-connector-for-outlook/generating-an-outlook-connector-log-file/ "Outlook troubleshooting: Generating an Outlook connector log file") and email them to us.  
Once you have the logs, please put them in a zipped file and [send them to us](/contact-us/) along with the following information:
