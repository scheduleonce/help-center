...
[When you configure the Outlook connector on your PC](/connecting-and-configuring-the-scheduleonce-connector-for-outlook "Connecting and configuring the ScheduleOnce connector for Outlook"), you can select different sync options between your Outlook Calendar and OnceHub.
