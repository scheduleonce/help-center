...
- **The Minimalist Approach:** [**Embed the Chatbot on your website**](/product/chatbots/embedding-your-chatbots-on-your-website) and use a welcome message to greet the visitor before handing the conversation entirely to the AI Agent.
...
Before you can add an AI Agent to a Chatbot, you must first create it. For detailed instructions on this process, please refer to [**How to Create an AI Agent**](/product/chatbots/how-to-create-an-ai-agent) article.
...
3. Use the **Monitored By** dropdown to select which Team will be able to [**monitor and barge into**](/product/chatbots/how-to-monitor-and-barge-into-ai-conversations) the AI Agent’s live conversations.
...
**A:** No. If you need to capture specific visitor information, it is recommended to use the dedicated [**Question Interactions**](/product/chatbots/adding-questions-to-your-chatbot) within your Chatbot instead of the AI Agent Action.

**How do I offer scheduling through the AI Agent?**

**A:** You can use the **Routing** tab to direct visitors to a [**Booking Calendar Interaction**](/product/chatbots/offering-scheduling-in-your-chatbot) once the AI Agent identifies that a visitor wants to book a call.
...
**A:** To alert your team members, add a [**User Notification Interaction**](/product/chatbots/setting-up-user-notifications-for-your-chatbot) to your Chatbot flow immediately before the **AI Agent** Interaction.
