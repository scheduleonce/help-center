...
Dynamic selection single-host meetings use [**Teams**](/product/booking-calendars/booking-settings/booking-calendar-meeting-distribution-options) to assign meetings to available team members based on predefined distribution methods, such as round-robin or load balancing.
