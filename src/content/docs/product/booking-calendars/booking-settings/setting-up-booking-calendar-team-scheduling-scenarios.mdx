...
[**Availability**](/product/booking-calendars/booking-settings/configuring-availability-for-specific-booking-calendars/) is determined by the time slots where all assigned users are available simultaneously.

### How to set up a panel meeting

1. Open the Booking Calendars lobby by clicking on [**Booking Calendars**](/product/booking-calendars/introduction-to-booking-calendars/introduction-to-booking-calendars/) in the lefthand side menu.

2. Click on the **Booking Calendar** you want to edit.

3. Use the **Add host and co-hosts** dropdown to select all users or [**Teams**](/product/booking-calendars/booking-settings/booking-calendar-meeting-distribution-options/) that should attend the booking, then click on **Add**.

   - If the Booking Calendar did not have a host before, a pop-up will appear to confirm who the host should be.
   - The email settings and [**Meeting locations**](/product/booking-calendars/booking-settings/configuring-availability-for-specific-booking-calendars/) that will be available for your guests to choose from is determined by the host you select.
...
5. Next you can click on **Manage** next to [**Workload**](/product/booking-calendars/booking-settings/booking-calendar-workload-management/) to define a maximum number of bookings that a team member can accept
