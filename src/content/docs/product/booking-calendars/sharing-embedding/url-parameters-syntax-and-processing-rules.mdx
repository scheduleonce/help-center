...
![Example of a booking link with URL parameters](files/bookinglink.jpeg)
...
| Phone                 | `phone=`        | Prefills the phone number for meetings using phone as the location. | `phone=+17793129776`        |
...
| Default Time Zone           | `iana_time_zone=`   | [**Sets the default time zone used to display availability to the guest.**](/product/booking-calendars/sharing-embedding/how-to-override-the-guest-time-zone-on-your-booking-link/) | `iana_time_zone=America/New_York` |
...
- **Mapped Questions:** If you have [**mapped the Booking Form Question to an Object Property**](/product/booking-calendars/booking-forms/mapping-booking-calendar-questions-to-object-properties/), the parameter will make use of the Property's Unique Identifier.
...
Use the [**Personalization and Tracking**](/product/booking-calendars/sharing-embedding/prefilling-guest-information-in-your-booking-calendar/) option in the Share popup of a Booking Calendar to confirm what the URL parameter is.
...
For Routing forms, it is important to know that you can only prefill [**Questions that are mapped to Object Properties**](/product/routing-forms/contact-data-management/mapping-routing-form-questions-to-object-properties/) by using the Property's Unique Identifier as the URL parameter.
