---
title: "Centralized Control with Automatic Updates"
description: "Centralized Control allows Administrators to enforce uniform settings across all associated Booking Calendars."
products:
  - oncehub
oldUrl: "https://help.oncehub.com/help/centralized-control-with-automatic-updates"
sidebar:
  order: 1
---
