---
title: "Resource pools: Assignment priority [Classic]"
---

import { Aside } from '@astrojs/starlight/components';

You can assign an Assignment priority to [Booking pages](/introduction-to-booking-pages/ "Introduction to Booking pages") within a [Resource pool](/introduction-to-resource-pools/ "VIDEO: Introduction to Resource pools") that uses [Pooled availability with priority](/distribution-method---pooled-availability-with-priority/ "Distribution method - Pooled availability with priority") as the distribution method. The Assignment priority determines which Booking page will receive a booking when multiple Booking pages are available at the time selected by the Customer. 

![](../../../../../assets/docs/booking-pages/master-pages-resource-pools-classic/resource-pools-classic/images/ass-pri.png)Figure 1: Resource pool Assignment priority
...
To edit the Assignment priority of Booking pages in a Resource pool, you must be a [OnceHub Administrator](/user-type-member-vs-admin-team-manager/ "Differences between Administrator and Member").
...
3.  ![](../../../../../assets/docs/booking-pages/master-pages-resource-pools-classic/resource-pools-classic/images/screenshot-2022-10-12-113426.png)
