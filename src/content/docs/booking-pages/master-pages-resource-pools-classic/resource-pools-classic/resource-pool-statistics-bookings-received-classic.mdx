---
title: "Resource pool statistics: Bookings received [Classic]"
---
...
**Bookings received** is a metric provided for each Booking page you've included in a [Resource pool](/introduction-to-resource-pools/ "Introduction to ScheduleOnce Resource pools"). **Bookings received** is the number of bookings that a specific [Booking page](/introduction-to-booking-pages/ "Introduction to Booking pages") has received to date, within the [Reporting cycle](/resource-pool-reporting-cycle/ "ScheduleOnce Resource pool: Reporting cycle").
...
To view the **Bookings received** metric, you must be a [OnceHub Administrator](/user-type-member-vs-admin-team-manager/ "Differences between Administrator and Member").
...
4.  Go to the **Resources** section of the Resource pool (Figure 2).  
    ![](../../../../../assets/docs/booking-pages/master-pages-resource-pools-classic/resource-pools-classic/images/product-team-rp-booking-rec.png)
...
If the specific [Resource pool is included in multiple Master pages](/adding-resource-pools-to-master-pages/ "Adding Resource pools to Master pages"), the **Bookings received** metric for each Booking page is the total number of bookings received by that Booking page across all Master pages.
