---
title: "Resource pool distribution method: Pooled availability with priority [Classic]"
---
...
9.  Go to the Resources section and select which Booking pages to include in the drop-down. Assign a priority to each Booking page in your pool (Figure 3). _![](../../../../../assets/docs/booking-pages/master-pages-resource-pools-classic/resource-pools-classic/images/1548080398307.png)Figure 3: Resource section_
