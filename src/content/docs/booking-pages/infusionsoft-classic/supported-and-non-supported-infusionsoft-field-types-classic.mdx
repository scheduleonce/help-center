---
title: "Supported and non-supported Infusionsoft field types [Classic]"
---

import { Aside } from '@astrojs/starlight/components';

In the [Mapping step of the Infusionsoft setup wizard](/mapping-scheduleonce-fields-to-infusionsoft-fields/ "Mapping ScheduleOnce fields to Infusionsoft fields"), you can map OnceHub fields to Infusionsoft fields. For each OnceHub field, the system will only show Infusionsoft fields that correspond to the selected OnceHub field type.
...
1.  **Supported OnceHub field types**  
    Our Infusionsoft integration supports all OnceHub field types, except for checkboxes. It means that almost all OnceHub System and Custom fields can be mapped to Infusionsoft fields in Mapping step of the Infusionsoft setup page.
...
2.  **Non-supported OnceHub field types**
    ...
    The checkbox field type will not appear in the [Mapping step of the Infusionsoft setup page](/mapping-scheduleonce-fields-to-infusionsoft-fields/ "Mapping ScheduleOnce fields to Infusionsoft fields").
...
1.  **Supported Infusionsoft field types**
    ...
    ![](../../../../assets/docs/booking-pages/infusionsoft-classic/images/1548674820108.png)
...
2.  **Non-supported Infusionsoft field types**
    ...
    ![](../../../../assets/docs/booking-pages/infusionsoft-classic/images/1548674820190.png)