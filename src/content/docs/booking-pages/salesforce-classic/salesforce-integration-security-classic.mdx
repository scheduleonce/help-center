---
title: "Salesforce integration security [Classic]"
---

import { Aside } from '@astrojs/starlight/components';

The [OnceHub integration with Salesforce](/the-scheduleonce-connector-for-salesforce/ "The ScheduleOnce integration with Salesforce") communicates with your Salesforce organization in real time using the Salesforce API. All API calls between OnceHub and Salesforce are made via a special [API User](/connecting-a-salesforce-api-user/ "How to connect a Salesforce API User") that is granted the OnceHub [permission set](/how-to-assign-the-scheduleonce-permission-set-to-the-salesforce-api-user/ "How to assign the ScheduleOnce permission set to the Salesforce API user"). This ensures that new records can always be created, and at the same time, the permissions of individual Salesforce users are not altered.
