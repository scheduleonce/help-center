---
title: "Using Salesforce Workflow Rules to update fields based on OnceHub data [Classic]"
---
...
3.  In the **Platform Tools** section, go to **Objects and Fields -> Object Manager** (Figure 1).  
    ![Object Manager - Workflow Field update in Salesforce](../../../../assets/docs/booking-pages/salesforce-classic/images/1566990756726.png)Figure 1: Object Manager in the Objects and Fields menu
4.  In the **Object Manager** list, select **Lead** (Figure 2).  
    ![Object Manager - Lead - Salesforce Workflow Rule](../../../../assets/docs/booking-pages/salesforce-classic/images/1567090640217.png)Figure 2: Lead in the Object Manager list
5.  Select **Field & Relationships -> New** (Figure 3).  
    ![Lead - Salesforce Update Field](../../../../assets/docs/booking-pages/salesforce-classic/images/1569239556616.png)Figure 3: Fields & Relationships
6.  In the **New** **Custom Field** pane, select **Text** and click **Next** (Figure 4).  
    ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569239698638.png)Figure 4: Text field
7.  In **Step 2: Enter the details**, enter the following information (Figure 5). Add a description if required, then click **Next**.
    ...
    *   **Field Name:** Event_Status   
        **![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569241468597.png)Figure 5: Step 2 Enter the details**
...
2.  In the New Custom field pane, select **Checkbox** and click **Next** (Figure 6).  
    ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569245388085.png)Figure 6: Checkbox
3.  In **Step 2: Enter the details**, enter the following information (Figure 5). Add a description if required, then click **Next**.
    ...
    *   **Field Name:** Event_Booked   
        ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569245924790.png)Figure 7: Step 2 Enter the details
...
8.  Click **Add fields**. 
    ...
    **Note**If you want to make the Workflow Rule specific to a [Booking page](/introduction-to-booking-pages/ "Introduction to Booking pages") or [Event type](/introduction-to-event-types/ "Introduction to Event types"), you can also map the OnceHub Booking page label or Event type name to specific Lead Custom fields. The Booking page label or Event type name can be used to refine the Salesforce Workflow rule that is triggered when a booking is made.
    
9.  For the newly added **Status** field, select **Lead** from the first drop-down menu and select **Event Status (Event_Status__c)** from the second drop-down menu (Figure 8).  
    ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569246544449.png)Figure 8: Map the Status field
...
3.  Select **Workflow Rules** (Figure 10).  
    ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1568109555419.png)Figure 9: Workflow Rules
4.  Click **New Rule**.
...
1.  On the **New Workflow Rule page** in Salesforce, fill out the following information and click **Save & Next** (Figure 11).
    ...
    *   **Rule Criteria:** Run this rule if the criteria are met:
        ...
        *   **Advance filter logic:** 1 OR 2  
            ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569247182313.png)Figure 10: Update Lead fields when event is scheduled or rescheduled by Customer
...
3.  Select **New Field Update** and add the following information (Figure 12):
    ...
    *   **Checkbox Options:** True  
        ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569247401796.png)Figure 11: Automatically check the Event _Booked_ checkbox
4.  Click **Save & New**.
5.  Add the following information (Figure 13):
    ...
    *   **Picklist Option > A specific value:** Working – Contacted  
        ![](../../../../assets/docs/booking-pages/salesforce-classic/images/1569247798369.png)Figure 12: Update the Lead Status picklist to Working - Contacted
6.  Click **Save**.
7.  Click **Done**.
