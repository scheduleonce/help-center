---
title: "Solutions for Customer onboarding [Classic]"
---
...
```
&lt;iframe allowfullscreen="" src="https://www.youtube-nocookie.com/embed/UkKlvNx5KcM?rel=0&amp;rel=0&amp;modestbranding=1" class="fr-draggable" width="640" height="360">&lt;/iframe>
```
...
*   The call-to-action to schedule can be placed in multiple places in your software. You can use our [Website embed](/website-embed/ "Website embed") or [Website buttons](/website-button/ "Website button") to integrate OnceHub with your app or portal.
...
*   Additionally, the Customer's profile data can be passed to OnceHub. [Login integration](/login-integration/ "Login Integration") will allow Customers to be recognized when they make a booking. It will ensure that Customers make the booking with the same email address that they have used to register for your portal, allowing you to relate the booking to your Customer records.
...
Beyond onboarding sessions, you can also use online scheduling together with our [Payment integration](/payment-integration-throughout-the-booking-lifecycle/ "Payment integration throughout the booking lifecycle") features to build online training catalogs. You can start by defining training courses consisting of single sessions or [multiple sessions](/single-or-multiple-sessions/ "Session packages"), in private or in [group format](/group-sessions-number-of-bookings-per-slot/ "Group sessions (number of bookings per slot)"). 
