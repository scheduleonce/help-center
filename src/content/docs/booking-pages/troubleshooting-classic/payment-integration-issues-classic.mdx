---
title: "Payment integration issues [Classic]"
---

import { Aside } from '@astrojs/starlight/components';

There are a number of reason why you might not be able to accept payments or process refunds via OnceHub. This article describes potential issues with [payment integration](/payment-integration-throughout-the-booking-lifecycle/ "Payment integration throughout the booking lifecycle (collecting payments from Customers)") and how these issues can be fixed.
...
[Learn more about connecting to your PayPal account](/connecting-scheduleonce-to-paypal/ "Connecting ScheduleOnce to PayPal")
...
If refunds cannot be processed, you should check errors related to your [Refund settings](/customizing-refund-settings/ "Customizing refund settings (collecting payments from Customers)"), the [Booking page Owner/Editor](/booking-page-ownership/ "Booking page ownership"), or the specific transaction. This might happen for the following reasons:
...
[Learn more about customizing Refund settings](/customizing-refund-settings/ "Customizing refund settings")
...
**Note**If you have explored all these options and you are still experiencing issues, please [contact us](/contact-us/).