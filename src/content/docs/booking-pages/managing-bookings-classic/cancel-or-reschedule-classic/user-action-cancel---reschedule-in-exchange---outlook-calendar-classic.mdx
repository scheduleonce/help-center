---
title: "User action: Cancel/reschedule in Exchange/Outlook Calendar [Classic]"
---
...
Once you have [connected to your Exchange/Outlook Calendar](/connecting-and-configuring-your-exchange-calendar/ "Connecting to your personal Exchange Calendar"), you can select whether changes made in your connected calendar are reflected in the OnceHub User app or not. 

**Note**This article applies to calendar actions done by Users while connected to Exchange/Outlook Calendar. It does not apply to other calendar integrations, or to any calendar action done by the Customer.
...
![](../../../../../assets/docs/booking-pages/managing-bookings-classic/cancel-or-reschedule-classic/images/1567690807248.png)Figure 1: Calendar connection—OnceHub advanced integration settings
...
*   If you're using [Payment integration](/the-scheduleonce-connector-for-paypal/ "The ScheduleOnce connector for PayPal"), no refund is issued. If your Customer is entitled to a refund, you can [refund them manually via OnceHub](/manual-refund-via-scheduleonce/ "Manual refund via ScheduleOnce") or via PayPal. 
...
*   The [status](/understanding-activity-statuses/ "Understanding activity statuses") of future events is changed to "Rescheduled".
