---
title: "Reschedule on the Same Booking Page [Classic]"
---
...
4.  If your Master pages uses Rule based assignment with Static rules: in the **Distribution method** section, check the box marked **Rescheduling is only possible on the page on which the booking was made** (Figure 1).  
    ![](../../../../../assets/docs/booking-pages/managing-bookings-classic/cancel-or-reschedule-classic/images/1554479831102.png)
...
5.  If your Master pages uses [Event types first](/event-types-first-booking-pages-second/ "Event types first (Booking pages second)") or [Booking pages first](/booking-pages-first-event-types-second/ "Booking pages first (Event types second)"): in **Assignment upon reschedule** section, check the box marked **Reschedule is only possible on the page on which the booking was made** (Figure 2).  
    ![](../../../../../assets/docs/booking-pages/managing-bookings-classic/cancel-or-reschedule-classic/images/1554479895720.png)
...
![](../../../../../assets/docs/booking-pages/managing-bookings-classic/cancel-or-reschedule-classic/images/1562063178658.png)Figure 3: Reschedule request email notification to Customer 
